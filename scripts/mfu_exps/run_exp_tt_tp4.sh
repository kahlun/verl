#!/usr/bin/env bash
# MFU Experiment: TorchTitan 4-GPU Llama-3.1-8B TP=4, FSDP2=1 (pure TP)
set -euo pipefail
...
CKPT_DIR=/root/verl/ckpts/mfu-tt-llama8b-tp4-fsdp1
