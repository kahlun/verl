...
- 3 verl upstream PRs submitted (#7098, #7184, ray#64440)
- 1 verl upstream PRs merged (#7128)
---
...
→ Need to add shared-memory fallback (same pattern vLLM already uses).
...
| 🟡 Backlog | VeOmni XPU engine registration |
